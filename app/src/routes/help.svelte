...
<html>
  ...
  <body>
    <p>
      You can use this app to show borderless, transparent, click-through
      browser windows for streaming. For example, you can show your Twitch chat
      stream and alerts on your display, over your game.
    </p>
    ...
    <p>
      <img style="width: 100%; height: auto" src="stream-overlay-clip.webp" />
    </p>
    ...
    <p>
      ...
      <code>resources/app</code> folder to <code>config.json</code>, then open
